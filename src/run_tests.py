...
if __name__ == "__main__":
    pool = mp.Pool(
        10, initializer=init_pool_processes
    )  # Max processes running at a time
    ...
    for generation in range(gen_limit):
        ...
        for chromosome in pop.population:
            ...
            processes = [
                pool.apply_async(run_game, args=(copy.deepcopy(network),))
        ...
        pop.new_generation(
            copy.deepcopy(parent1), copy.deepcopy(parent2), copy.deepcopy(child)
        )
