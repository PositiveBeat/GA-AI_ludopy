...
class Network:
    ...
    def compute_result(self, input):
        ...
        result = self.output_layer.compute_layer(network_result, activation_func='sigmoid') # Final result
...
if __name__ == '__main__':
    ...
    pop = Population(50, network.total_nr_elements)
